...
const Footer = () => {
  ...
  return (
    <footer className="bg-white dark:bg-darkThemeBG  p-4 md:p-6 xl:p-8 xl:px-16  ">
      <div className=" flex sm:flex-row flex-col md:items-center items-center gap-y-2 justify-between  ">
        ...
        <div className="flex sm:justify-center space-x-6">
          <a
            href="https://github.com/Mohamed-gp/SocialSync"
            target="_blank"
            className=""
          >
            <svg
